...
$o_results = $o_mysql_connection->query("SELECT Description from " . TABLE_PREFIX . "styles where Type = 'single' AND Name = '" . $v_style . "' AND Page<='" . $v_current . "' ORDER BY Page DESC LIMIT 1");
